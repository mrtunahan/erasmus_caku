    ...
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 24 }}>
        ...
        <button onClick={() => { resetForm(); setShowForm(true); }} style={{
          ...
          <KomIcon path="M12 5v14M5 12h14" size={16} />
          Yeni Komisyon
        </button>
      </div>
      ...
      {msg && (
        <div style={{
          ...
          background: msg.includes("hata") || msg.includes("zorunlu") ? KOM.redLight : KOM.greenLight,
      ...
      <div style={{
        ...
        {[
          ...
          { label: "Toplam Üye", value: commissions.reduce((acc, c) => acc + (c.members?.length || 0), 0), color: "#3B82F6" },
          ...
          <div key={i} style={{
            ...
            <div style={{ fontSize: 12, color: KOM.textMuted, marginTop: 4 }}>{s.label}</div>
          </div>
        ))}
      </div>
        ...
        <div style={{ ...cardStyle, padding: responsive.val(16, 20, 24), marginBottom: 24 }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
            <button onClick={resetForm} style={{
              ...
              background: "white", color: KOM.textMuted, fontSize: 13, cursor: "pointer",
            }}>İptal</button>
            <button onClick={handleSave} style={{
              padding: "10px 20px", borderRadius: 8, border: "none",
              background: KOM.primary, color: "white", fontSize: 13, fontWeight: 600, cursor: "pointer",
      ...
      {commissions.length === 0 && !showForm ? (
        <div style={{ ...cardStyle, padding: 40, textAlign: "center" }}>
          <KomIcon path="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" size={48} color="#D1D5DB" />
          <p style={{ color: KOM.textMuted, fontSize: 14, marginTop: 16 }}>
            ...
            return (
              <div key={comm.id} style={{
                ...
                <div style={{
                  ...
                  <div style={{ flex: 1, cursor: "pointer" }} onClick={() => setSelectedCommission(isSelected ? null : comm)}>
                    <div style={{ fontSize: 15, fontWeight: 600, color: KOM.navy }}>{comm.name}</div>
                  ...
                  <div style={{ display: "flex", gap: 4 }}>
                    <button onClick={() => handleEdit(comm)} title="Düzenle" style={{
                      background: "none", border: "none", cursor: "pointer", padding: 6,
                      color: "#6B7280", borderRadius: 6,
                    }}>
                      <KomIcon path="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" size={16} />
                    </button>
                    <button onClick={() => handleDelete(comm.id)} title="Sil" style={{
                      background: "none", border: "none", cursor: "pointer", padding: 6,
                      color: KOM.red, borderRadius: 6,
                    }}>
                      <KomIcon path="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" size={16} />
                    </button>
                  </div>
                </div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                      {(comm.members || []).slice(0, isSelected ? undefined : 3).map(member => (
                        <div key={member.name} style={{
                          ...
                          <div style={{ flex: 1 }}>
                            <span style={{ fontSize: 12, fontWeight: 500, color: KOM.text }}>{member.name}</span>
                          </div>
                          <span style={{
                      ...
                      {!isSelected && memberCount > 3 && (
                        <div style={{
                          fontSize: 11, color: KOM.primary, cursor: "pointer", fontWeight: 500,
                          paddingTop: 4,
