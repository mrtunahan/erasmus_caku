  ...
  gruplar.forEach((grup, sinif) => {
    ...
    sirali.forEach((k) => {
      ...
      if (asilNo < asil) {
        ...
        // Kontenjan doldu → sıraya girdi ama yerleşemedi. Sebep belgeye
        // yazılır: asil olmayan her satırın NEDEN öyle olduğu çıktıda
        // görünmeli, yoksa "UYGUN DEĞİL" gerekçesiz bir karar gibi durur.
        oneri.push({
          id,
          degerlendirme: 'uygun_degil',
          degerlendirmeSinif: sinif,
