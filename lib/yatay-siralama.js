...
export function asilYedekOner(kayitlar, turId, kontenjan, yedekSayisi, secenek) {
  // Kurumun taban ÖSYM puanının altında kalanlar sıralamaya girmez: puanı
  // ne olursa olsun şartı taşımıyorlar ve kontenjanı işgal etmemeliler.
