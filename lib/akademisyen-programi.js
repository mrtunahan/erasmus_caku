...
import { etiketBaslangici } from './ders-saatleri.js';

export const PROGRAM_GUNLERI = ['Pazartesi', 'Salı', 'Çarşamba', 'Perşembe', 'Cuma'];

// İlk 9 satır lisans, sonrası akşam (lisansüstü) saatleridir.
//
// Ders 08:15'te başlar ve saat başı tekrarlar: 45 dakika ders + 15 dakika ara
// (08:15-09:00, 09:15-10:00 …). Önceden ilk sekiz satır yarım saat kaymıştı
// (08:30-09:15 …) ve akşam satırlarıyla aynı düzeni tutmuyordu; artık on dört
// satırın tamamı tek kurala uyar.
//
