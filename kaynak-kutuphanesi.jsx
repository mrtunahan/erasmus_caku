...
const RESOURCE_CATEGORIES = [
  ...
  },
  {
    ...
    icon: 'M4 19.5A2.5 2.5 0 016.5 17H20M4 19.5V5a2 2 0 012-2h14v14H6.5a2.5 2.5 0 00-2.5 2.5z',
    color: '#7c3aed',
    bg: '#ede9fe',
  },
  {
...
function KaynakKutuphanesiApp({ currentUser, activeDepartment }) {
  ...
  const loadResources = async () => {
    setLoading(true);
    try {
      const allData = await window.apiRead('resources', { orderBy: 'createdAt:desc' });
  ...
  const getCategoryInfo = (catKey) =>
    RESOURCE_CATEGORIES.find((c) => c.key === catKey) ||
  ...
  // ══════════════════════════════════════════════════════════════
  return (
    <div style={{ background: KTB.bg, padding: '0 0 40px' }}>
      {/* Header */}
      <div
        style={{
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 4px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              >
                <KtbIcon path={KTB_ICONS.folder} size={28} color="rgba(255,255,255,0.8)" /> Kaynak
                Kütüphanesi
              </h1>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 4px' }}>
        ...
        <div style={{ display: 'flex', gap: 24 }}>
            ...
            >
              ...
              {RESOURCE_CATEGORIES.map((cat) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    if (selectedCategory !== cat.key) e.currentTarget.style.background = '#fafafa';
                  }}
                  onMouseLeave={(e) => {
                    if (selectedCategory !== cat.key) e.currentTarget.style.background = 'white';
                  }}
                >
                  ...
                  <span
                    style={{
                      fontSize: 11,
                      background:
                        selectedCategory === cat.key ? 'rgba(255,255,255,0.6)' : '#f3f4f6',
                      padding: '2px 8px',
                      borderRadius: 10,
                    }}
                  >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            {loading ? (
              <div style={{ textAlign: 'center', padding: 60, color: KTB.textMuted }}>
                Yükleniyor...
              </div>
  ...
  return (
    <div
      ...
      onMouseLeave={(e) => {
        ...
        e.currentTarget.style.borderColor = KTB.border;
      }}
    >
      {/* Dosya Tipi İkonu */}
      <div
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            ...
            {resource.description && (
              <p style={{ fontSize: 13, color: KTB.textMuted, marginBottom: 6 }}>
                {resource.description}
              </p>
            )}
            <div
            ...
            >
              ...
              <span>
                <KtbIcon path={KTB_ICONS.download} size={11} /> {resource.downloadCount || 0}{' '}
                indirme
              </span>
      ...
      >
          ...
          >
            {fileName ? (
              <div>
                ...
                <div style={{ fontSize: 14, fontWeight: 600, color: KTB.text, marginTop: 6 }}>
                  {fileName}
                </div>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <textarea
            ...
            placeholder="Kaynak hakkında bilgi..."
            rows={2}
            style={{
              width: '100%',
              padding: '10px 14px',
