...
// ── Taban puan okuma KALDIRILDI ──
//
// Model artık web'den taban puan okumuyor. Bu veri yılda BİR kez yayımlanan,
// ~50 satırlık, insanın gözüyle doğrulayabileceği küçük bir tablo; her
// seferinde web'e çıkan bir model çalıştırmak hem pahalıydı hem kırılgandı —
// kurumlar aynı yıl için ÖNLİSANS / LİSANS / DGS listelerini ayrı ayrı
// yayımlıyor ve model yanlış listeyi açabiliyordu. Yeni akış istemcide:
// yetkili tabloyu yapıştırır ya da PDF/CSV yükler, lib/taban-tablo.js düz
// kodla ayrıştırır, yetkili onaylar. Tabloyu İNSAN seçtiği için "yanlış
// liste" hata sınıfı da ortadan kalktı.
//
// Birlikte düşen tesisat: TABAN_MODEL, web_fetch araçları, tabanUrlCoz,
// getirmeleriTopla, TABAN_TALIMATI ve pause_turn döngüsü. web_search
// (WEB_ARAMA_ARACI) duruyor — onu webDogrula kullanıyor.
