...
// ── Taban puan uçları KALDIRILDI ──
//
// Taban puanlar artık modelle web'den okunmuyor. Yılda bir kez yayımlanan,
// ~50 satırlık bir tablo için her seferinde web'e çıkan bir model çalıştırmak
// hem pahalıydı hem kırılgandı: kurumlar aynı yıl için ÖNLİSANS / LİSANS /
// DGS listelerini ayrı ayrı yayımlıyor ve model yanlış listeyi açabiliyordu.
// Yeni akış tamamen istemcide: yetkili tabloyu yapıştırır ya da PDF/CSV
// yükler, lib/taban-tablo.js düz kodla ayrıştırır, yetkili onaylar.
// Kayıt yeri değişmedi (taban_puanlar koleksiyonu).
